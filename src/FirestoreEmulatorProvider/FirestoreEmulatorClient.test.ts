...
import FirestoreEmulatorClient from "./FirestoreEmulatorClient";
import * as path from "path";
import * as firebase from "@firebase/testing";

describe("全て拒否設定", () => {
    const provider = new FirestoreEmulatorClient("my-test-project", path.join(__dirname, "firestore.rules"));
